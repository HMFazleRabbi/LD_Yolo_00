...
__C.YOLO.DEMO_WEIGHT            = "./checkpoint/Pretrained_Weight/yolov3_coco_demo.ckpt"
...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/Exp-2-0/Exp-2-0_test_loss=5.1105.ckpt"
...
__C.TEST.WEIGHT_FILE            = "./checkpoint/Exp-2-0/Exp-2-0_test_loss=5.1105.ckpt-50"
